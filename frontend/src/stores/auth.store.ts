...
export const DEMO_USERS: Record<UserRole, User> = {
  SUPER_ADMIN: {
    ...
    jobTitle: 'Global Platform Chief & Orchestrator',
    ...
    companyId: 'comp-1', // Default focus, but has omnipotent access
  ...
  SUPERADMIN: {
    ...
    twoFactorEnabled: true,
    role: 'SUPERADMIN',
    roleTitle: ROLE_LABELS.SUPERADMIN,
    companyId: 'comp-1',
    companyName: 'Platform Global Master',
  ...
  ADMIN: {
    ...
    jobTitle: 'Company Director & Administrator',
  ...
  RETAILER: {
    id: 'usr-retailer-1',
    name: 'Reliance Metro Retailers (Direct Dealer)',
    firstName: 'Mukesh',
    lastName: 'Singhal',
    email: 'mukesh@metroretailers.in',
    phone: '+91 99880 11223',
    jobTitle: 'Head of Procurement & Wholesale Ops',
    department: 'Wholesale B2B Purchasing',
    team: 'dealers',
    ...
    twoFactorEnabled: true,
    role: 'RETAILER',
    roleTitle: ROLE_LABELS.RETAILER,
    companyId: 'comp-1',
    companyName: 'Apex Enterprise Solutions Ltd',
